...
//     weather1.innerHTML = `<div class="spinner-border text-primary" role="status"><span class="visually-hidden"></span></div>`
...
// const showData = (data)=>{
//     if (data.cod == "404") {  
//         weather1.innerHTML = `<h1>${data.message}</h1>`
//         return;}else{
//     weather1.innerHTML=`<img src=${`https://openweathermap.org/img/wn/${data.weather[0].icon}@2x.png`} width="80" alt="">
